...
* English units are used by a class, but that class should also provide SI equivalents.  REVS provides some frameworks for and examples of automatic unit conversions that may be used.
